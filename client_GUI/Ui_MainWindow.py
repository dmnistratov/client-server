...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.timeout_fast.setGeometry(QtCore.QRect(155, 260, 21, 21))
        ...
        self.timeout_slow.setGeometry(QtCore.QRect(545, 260, 21, 21))
        ...
        self.timeout_slider_slow_2 = QtWidgets.QSlider(self.centralwidget)
        self.timeout_slider_slow_2.setGeometry(QtCore.QRect(465, 40, 251, 27))
        self.timeout_slider_slow_2.setMinimum(1)
        self.timeout_slider_slow_2.setMaximum(10)
        self.timeout_slider_slow_2.setPageStep(1)
        self.timeout_slider_slow_2.setProperty("value", 1)
        self.timeout_slider_slow_2.setOrientation(QtCore.Qt.Horizontal)
        self.timeout_slider_slow_2.setTickPosition(QtWidgets.QSlider.TicksBelow)
        self.timeout_slider_slow_2.setTickInterval(1)
        self.timeout_slider_slow_2.setObjectName("timeout_slider_slow_2")
